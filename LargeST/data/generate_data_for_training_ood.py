...
def generate_train_val_test(args):
    ...
    for y in years:
        print('Year is', y)
        df = pd.read_hdf(args.dataset + '/' + args.dataset + '_his_' + y + '.h5')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='ca', help='dataset name and and if generate multiple datasets, please use underline to separate them, e.g., sd_gba')
