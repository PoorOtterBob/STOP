...
if __name__ == '__main__':
    ...
    parser.add_argument('--years', type=str, default='2011_2012_2013_2014_2015_2016_2017', help='if use data from multiple years, please use underline to separate them, e.g., 2018_2019')
