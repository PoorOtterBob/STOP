...
class BaseEngine():
    def __init__(self, device, model, optimizer, scheduler, 
                 node_training, node_test, node_sood_num, adj, adj_test, 
    ...
    def _adj_cal(self, adj=None, node_order=None):
        if adj is None:
            return None
        else:
    ...
    def evaluate(self, mode, adj=None):
        if mode == 'test':
            ...
            tood = 0 # self._tood
            adj = self._adj_cal(self._adj_test)
        else:
