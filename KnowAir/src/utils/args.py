...
def get_star_config():
    ...
    parser.add_argument('--dataset', type=str, default='KnowAir')
    # if need to use the data from multiple years, please use underline to separate them, e.g., 2018_2019
    parser.add_argument('--years', type=str, default='2015')
    parser.add_argument('--checkyears', type=int, default=2015)
    ...
    parser.add_argument('--input_dim', type=int, default=13+2)
